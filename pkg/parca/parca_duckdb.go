...
// initDuckDBBackend wires up the embedded DuckDB storage backend. It is only
// compiled into binaries built with the "duckdb" build tag, because
// github.com/marcboeker/go-duckdb links a static libduckdb through cgo and can
// therefore not be part of the default CGO-free, cross-compiled release build.
...
// duckdbPathDescription returns a human-friendly description of the configured
// DuckDB path for log output.
