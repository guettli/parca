...
// setupDuckDBBackend initializes the embedded DuckDB storage backend. It is only
// compiled into cgo-enabled builds because github.com/marcboeker/go-duckdb links
// libduckdb via cgo; CGO-free release binaries use the stub in
// backend_duckdb_stub.go instead.
func setupDuckDBBackend(
	ctx context.Context,
	logger log.Logger,
	flags *Flags,
	tracerProvider trace.TracerProvider,
	sharedSymbolizer symbolizer.SymbolizationClient,
