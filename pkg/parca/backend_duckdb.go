...
// compiled into binaries built with the `duckdb` build tag (see
// Dockerfile.duckdb), because github.com/marcboeker/go-duckdb links a static
// libduckdb via cgo and cannot be part of the default CGO-free release build.
